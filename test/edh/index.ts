...
const ORDER = [
  ...
  'files.test.cjs', //       Directory section of Focus (cleans up after itself)
  'lanes.test.cjs', //       Lanes panel: the ladder, groups, no duplicates
  ...
  'shell.test.cjs', //       driving the preview from a shell: settings, recipe, rebuild
